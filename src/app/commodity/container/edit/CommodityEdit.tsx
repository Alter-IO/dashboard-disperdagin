...
import { useEditCommodity } from "../../usecase/useEditCommodity";
...
export const CommodityEditContainer = () => {
    ...
    const form = useForm<z.infer<typeof FormSchema>>({
        ...
        values: {
            commodity_type_id: commodity?.data.commodity_type_id || "",
            author: commodity?.data.author || "",
            description: commodity?.data.description || "",
            name: commodity?.data.name || "",
            price: commodity?.data.price || 0,
            publish_date: commodity?.data.publish_date ? new Date(commodity.data.publish_date) : new Date(),
            unit: commodity?.data.unit || "",
        }
    })
    ...
    function onSubmit(data: z.infer<typeof FormSchema>) {
        const payload: IPostPutCommodity = {
            ...
            name: data.name,
            price: data.price,
            publish_date: data.publish_date.toLocaleDateString('en-CA', { timeZone: 'Asia/Singapore' }),
            unit: data.unit,
    ...
    return (
        <Card className="m-4">
            <CardHeader>
                <CardTitle>Edit Kommodity</CardTitle>
            </CardHeader>
            <CardContent>
                <Form {...form}>
